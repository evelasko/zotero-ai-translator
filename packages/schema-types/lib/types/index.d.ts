...
export interface ZoteroAudioRecordingItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'performer' | 'contributor' | 'composer' | 'wordsBy';
    })[];
}
...
export interface ZoteroBlogPostItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'author' | 'commenter' | 'contributor';
    })[];
}
export interface ZoteroBookItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'author' | 'contributor' | 'editor' | 'translator' | 'seriesEditor';
    })[];
}
export interface ZoteroBookSectionItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'author' | 'contributor' | 'editor' | 'bookAuthor' | 'translator' | 'seriesEditor';
    })[];
}
...
export interface ZoteroDocumentItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'author' | 'contributor' | 'editor' | 'translator' | 'reviewedAuthor';
    })[];
}
...
export interface ZoteroFilmItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'director' | 'contributor' | 'scriptwriter' | 'producer';
    })[];
}
...
export interface ZoteroPodcastItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'podcaster' | 'contributor' | 'guest';
    })[];
}
...
export interface ZoteroPresentationItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'presenter' | 'contributor';
    })[];
}
export interface ZoteroRadioBroadcastItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'director' | 'scriptwriter' | 'producer' | 'castMember' | 'contributor' | 'guest';
    })[];
}
export interface ZoteroReportItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'author' | 'contributor' | 'translator' | 'seriesEditor';
    })[];
}
...
export interface ZoteroVideoRecordingItem extends ZoteroItemData {
    ...
    extra?: string;
    creators?: (ZoteroCreator & {
        creatorType: 'director' | 'scriptwriter' | 'producer' | 'castMember' | 'contributor';
    })[];
}
